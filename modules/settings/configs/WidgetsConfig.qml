...
Item {
    ...
    property var calendarWidgets: (WidgetsRegistry.allWidgets || []).filter(function(w) { return w.category === "Calendar"; })
    property var utilityWidgets: (WidgetsRegistry.allWidgets || []).filter(function(w) { return w.category === "Utility"; })
    property var systemWidgets: (WidgetsRegistry.allWidgets || []).filter(function(w) { return w.category === "System"; })
        ...
        ContentSection {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ConfigSlider {
                        Layout.fillWidth: true
                        text: Translation.tr("Move all X")
                        value: 0
                        from: -500
                        to: 500
                        stepSize: 10
                        onValueChanged: {
                            if (value !== 0) {
                                Config.offsetAllWidgets(value, 0);
                                value = 0;
                            }
                        }
                    }
                    ...
                    ConfigSlider {
                        Layout.fillWidth: true
                        text: Translation.tr("Move all Y")
                        value: 0
                        from: -500
                        to: 500
                        stepSize: 10
                        onValueChanged: {
                            if (value !== 0) {
                                Config.offsetAllWidgets(0, value);
                                value = 0;
                            }
                        }
                    }
            ...
            ContentSubsection {
                ...
                Flow {
                    ...
                    spacing: 12
                    Repeater {
                        model: widgetsConfigRoot.dateWidgets.concat(widgetsConfigRoot.calendarWidgets)
                        delegate: widgetCardComponent
                    }
                }
            }
            ...
            ContentSubsection {
                ...
                icon: "monitor"
                Layout.fillWidth: true
                visible: widgetsConfigRoot.systemWidgets.length > 0
            ...
            ContentSubsection {
                ...
                icon: "build"
                Layout.fillWidth: true
                visible: widgetsConfigRoot.utilityWidgets.length > 0
            ...
            ContentSubsection {
                ...
                ColumnLayout {
                    ...
                    ConfigSelectionArray {
                        Layout.fillWidth: true
                        currentValue: Config.options.background.widgets.customImage?.shape ?? "Cookie4Sided"
                        onSelected: newValue => { Config.options.background.widgets.customImage.shape = newValue; }
                        options: (["Circle", "Square", "Slanted", "Arch", "Fan", "Arrow", "SemiCircle", "Oval", "Pill", "Triangle", "Diamond", "ClamShell", "Pentagon", "Gem", "Sunny", "VerySunny", "Cookie4Sided", "Cookie6Sided", "Cookie7Sided", "Cookie9Sided", "Cookie12Sided", "Ghostish", "Clover4Leaf", "Clover8Leaf"]).map(s => ({
                            displayName: "",
                            shape: s,
                            value: s
                        }))
                    ...
                    ConfigSlider {
                        ...
                        value: Config.options.background.widgets.customImage?.size ?? 200
                        from: 50
                        to: 600
                        stepSize: 10
                        onValueChanged: {
