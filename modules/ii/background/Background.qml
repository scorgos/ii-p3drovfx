...
Scope {
    ...
    topMargin: 0
                                ...
                                Component {
                                    id: component_resources_default
                                    ResourcesWidget {
                                        screenWidth: bgRoot.screen.width
                                        screenHeight: bgRoot.screen.height
                                        scaledScreenWidth: bgRoot.screen.width / bgRoot.effectiveWallpaperScale
                                ...
                                Component {
                                    id: component_visualizer_default
                                    VisualizerWidget {
                                        screenWidth: bgRoot.screen.width
                                        screenHeight: bgRoot.screen.height
                                        scaledScreenWidth: bgRoot.screen.width / bgRoot.effectiveWallpaperScale
                                ...
                                Component {
                                    id: component_worldclock_default
                                    WorldClockWidget {
                                        screenWidth: bgRoot.screen.width
                                        screenHeight: bgRoot.screen.height
                                        scaledScreenWidth: bgRoot.screen.width / bgRoot.effectiveWallpaperScale
                                ...
                                Component {
                                    id: component_weather_classic
                                    WeatherWidgetClassic {
                                        screenWidth: bgRoot.screen.width
                                        screenHeight: bgRoot.screen.height
                                        scaledScreenWidth: bgRoot.screen.width / bgRoot.effectiveWallpaperScale
                                        scaledScreenHeight: bgRoot.screen.height / bgRoot.effectiveWallpaperScale
                                ...
                                property var widgetComponentMap: ({
                                    ...
                                    "calendar_default": component_calendar_default,
                                    "images_converter": component_images_converter,
                                    "images_custom": component_images_custom,
                                    "resources_default": component_resources_default,
                                    "usercard_default": component_usercard_default,
                                    "visualizer_default": component_visualizer_default,
                                    "worldclock_default": component_worldclock_default,
                                    "media_classic": component_media_classic,
                                    "weather_classic": component_weather_classic
                                })
